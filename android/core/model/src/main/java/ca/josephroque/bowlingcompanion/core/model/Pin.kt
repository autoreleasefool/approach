...
fun Set<Pin>.isLeftChop(): Boolean = size == 3 &&
	contains(
		Pin.HEAD_PIN,
	) &&
	contains(Pin.LEFT_TWO_PIN) &&
	contains(Pin.LEFT_THREE_PIN)
fun Set<Pin>.isRightChop(): Boolean = size == 3 &&
	contains(
		Pin.HEAD_PIN,
	) &&
	contains(Pin.RIGHT_TWO_PIN) &&
	contains(Pin.RIGHT_THREE_PIN)
fun Set<Pin>.isChop(): Boolean = isLeftChop() || isRightChop()

fun Set<Pin>.isLeftSplit(): Boolean = size == 2 &&
	contains(
		Pin.HEAD_PIN,
	) &&
	contains(Pin.LEFT_THREE_PIN)
fun Set<Pin>.isLeftSplitWithBonus(): Boolean = size == 3 &&
	contains(
		Pin.HEAD_PIN,
	) &&
	contains(Pin.LEFT_THREE_PIN) &&
	contains(Pin.RIGHT_TWO_PIN)
fun Set<Pin>.isRightSplit(): Boolean = size == 2 &&
	contains(
		Pin.HEAD_PIN,
	) &&
	contains(Pin.RIGHT_THREE_PIN)
fun Set<Pin>.isRightSplitWithBonus(): Boolean = size == 3 &&
	contains(
		Pin.HEAD_PIN,
	) &&
	contains(Pin.RIGHT_THREE_PIN) &&
...
fun Set<Pin>.isLeftFive(): Boolean = size == 2 &&
	contains(
		Pin.LEFT_TWO_PIN,
	) &&
	contains(Pin.LEFT_THREE_PIN)
fun Set<Pin>.isRightFive(): Boolean = size == 2 &&
	contains(
		Pin.RIGHT_TWO_PIN,
	) &&
	contains(Pin.RIGHT_THREE_PIN)
