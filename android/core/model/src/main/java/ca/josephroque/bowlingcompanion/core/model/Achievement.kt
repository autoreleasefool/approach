...
data class Achievement(val id: AchievementID, val title: String, val earnedAt: Instant)

data class AchievementListItem(val title: String, val firstEarnedAt: Instant, val count: Int)
