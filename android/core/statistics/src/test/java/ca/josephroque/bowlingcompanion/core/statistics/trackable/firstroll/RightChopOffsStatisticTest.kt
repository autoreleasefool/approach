...
class RightChopOffsStatisticTests {
	@Test
	fun testAdjust_ByFramesWithRightChopOffs_Adjusts() {
		val statistic = assertStatisticAdjusts(
			statistic = RightChopOffsStatistic(),
			byFrames = listOf(
				frame(0, listOf(
	...
	@Test
	fun testAdjust_ByFramesWithoutRightChopOffs_DoesNotAdjust() {
		val statistic = assertStatisticAdjusts(
			statistic = RightChopOffsStatistic(),
			byFrames = listOf(
				frame(0, listOf(
