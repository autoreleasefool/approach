...
class LeftChopOffsSparedStatisticTest {
	@Test
	fun testAdjust_ByFramesWithLeftChopOffsSpared_Adjusts() {
		val statistic = assertStatisticAdjusts(
			statistic = LeftChopOffsSparedStatistic(),
			byFrames = listOf(
				frame(0, listOf(
	...
	@Test
	fun testAdjust_ByFramesWithoutLeftChopOffsSpared_DoesNotAdjust() {
		val statistic = assertStatisticAdjusts(
			statistic = LeftChopOffsSparedStatistic(),
			byFrames = listOf(
				frame(0, listOf(
	...
	@Test
	fun testAdjust_InLastFrame_ByFramesWithLeftChopsSpared_Adjusts() {
		val statistic = assertStatisticAdjusts(
			statistic = LeftChopOffsSparedStatistic(),
			byFrames = listOf(
				// Open attempt
				...
				frame(Game.NumberOfFrames - 1, listOf(
					...
					roll(1, setOf(Pin.HEAD_PIN, Pin.LEFT_THREE_PIN, Pin.LEFT_TWO_PIN)),
				...
				frame(Game.NumberOfFrames - 1, listOf(
					...
					roll(2, setOf(Pin.HEAD_PIN, Pin.LEFT_THREE_PIN, Pin.LEFT_TWO_PIN)),
				)),
				// Three strikes
				frame(Game.NumberOfFrames - 1, listOf(
					roll(0, setOf(Pin.RIGHT_TWO_PIN, Pin.RIGHT_THREE_PIN, Pin.HEAD_PIN, Pin.LEFT_THREE_PIN, Pin.LEFT_TWO_PIN)),
