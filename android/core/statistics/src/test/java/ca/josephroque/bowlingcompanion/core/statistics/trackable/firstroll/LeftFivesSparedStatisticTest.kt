...
class LeftFivesSparedStatisticTest {
	@Test
	fun testAdjust_ByFramesWithLeftFivesSpared_Adjusts() {
		val statistic = assertStatisticAdjusts(
			statistic = LeftFivesSparedStatistic(),
			byFrames = listOf(
				frame(0, listOf(
				...
				frame(1, listOf(
					...
					roll(1, setOf(Pin.HEAD_PIN, Pin.LEFT_TWO_PIN, Pin.LEFT_THREE_PIN)),
				)),
				frame(2, listOf(
	...
	@Test
	fun testAdjust_ByFramesWithoutLeftFivesSpared_DoesNotAdjust() {
		val statistic = assertStatisticAdjusts(
			statistic = LeftFivesSparedStatistic(),
			byFrames = listOf(
				frame(0, listOf(
	...
	@Test
	fun testAdjust_InLastFrame_ByFramesWithLeftFivesSpared_Adjusts() {
		val statistic = assertStatisticAdjusts(
			statistic = LeftFivesSparedStatistic(),
			byFrames = listOf(
				frame(
					...
					roll(0, setOf(Pin.LEFT_THREE_PIN, Pin.LEFT_TWO_PIN)),
					roll(1, setOf(Pin.RIGHT_THREE_PIN, Pin.HEAD_PIN)),
				...
				frame(
					...
					roll(2, setOf(Pin.RIGHT_TWO_PIN, Pin.RIGHT_THREE_PIN, Pin.HEAD_PIN, Pin.LEFT_THREE_PIN, Pin.LEFT_TWO_PIN)),
				)),
				frame(
					Game.NumberOfFrames - 1, listOf(
					roll(0, setOf(Pin.LEFT_THREE_PIN, Pin.LEFT_TWO_PIN)),
				...
				frame(
					Game.NumberOfFrames - 1, listOf(
					roll(0, setOf(Pin.RIGHT_TWO_PIN, Pin.RIGHT_THREE_PIN, Pin.HEAD_PIN, Pin.LEFT_THREE_PIN, Pin.LEFT_TWO_PIN)),
					roll(1, setOf(Pin.LEFT_THREE_PIN, Pin.LEFT_TWO_PIN)),
					roll(2, setOf(Pin.RIGHT_TWO_PIN, Pin.RIGHT_THREE_PIN, Pin.HEAD_PIN)),
				)),
				frame(
					Game.NumberOfFrames - 1, listOf(
					roll(0, setOf(Pin.RIGHT_TWO_PIN, Pin.RIGHT_THREE_PIN, Pin.HEAD_PIN, Pin.LEFT_THREE_PIN, Pin.LEFT_TWO_PIN)),
				...
				frame(
					Game.NumberOfFrames - 1, listOf(
					roll(0, setOf(Pin.RIGHT_TWO_PIN, Pin.RIGHT_THREE_PIN, Pin.HEAD_PIN, Pin.LEFT_THREE_PIN, Pin.LEFT_TWO_PIN)),
					roll(1, setOf(Pin.RIGHT_TWO_PIN, Pin.RIGHT_THREE_PIN, Pin.HEAD_PIN, Pin.LEFT_THREE_PIN, Pin.LEFT_TWO_PIN)),
					roll(2, setOf(Pin.LEFT_THREE_PIN, Pin.LEFT_TWO_PIN)),
				)),
				frame(
					Game.NumberOfFrames - 1, listOf(
					roll(0, setOf(Pin.RIGHT_TWO_PIN, Pin.RIGHT_THREE_PIN, Pin.HEAD_PIN, Pin.LEFT_THREE_PIN, Pin.LEFT_TWO_PIN)),
