...
class LeftTwelvesStatisticTest {
	@Test
	fun testAdjust_ByFramesWithLeftTwelves_Adjusts() {
		val statistic = assertStatisticAdjusts(
			statistic = LeftTwelvesStatistic(),
			byFrames = listOf(
				frame(0, listOf(
	...
	@Test
	fun testAdjust_ByFramesWithoutLeftTwelves_DoesNotAdjust() {
		val statistic = assertStatisticAdjusts(
			statistic = LeftTwelvesStatistic(),
			byFrames = listOf(
				frame(0, listOf(
