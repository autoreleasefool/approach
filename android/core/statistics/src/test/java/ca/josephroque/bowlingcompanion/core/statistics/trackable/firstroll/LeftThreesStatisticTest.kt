...
class LeftThreesStatisticTest {
	@Test
	fun testAdjust_ByFramesWithLeftThrees_Adjusts() {
		val statistic = assertStatisticAdjusts(
			statistic = LeftThreesStatistic(),
			byFrames = listOf(
				frame(
					0,
					listOf(
	...
	@Test
	fun testAdjust_ByFramesWithoutLeftThrees_DoesNotAdjust() {
		val statistic = assertStatisticAdjusts(
