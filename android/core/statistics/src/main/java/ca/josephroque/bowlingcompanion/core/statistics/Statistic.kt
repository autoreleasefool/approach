...
enum class StatisticCategory {
	OVERALL {
		override val titleResourceId = R.string.statistic_category_overall
	},
	MIDDLE_HITS {
		override val titleResourceId = R.string.statistic_category_middle_hits
	},
	STRIKES_AND_SPARES {
	...
	FIVES {
		override val titleResourceId = R.string.statistic_category_fives
	},
	THREES {
		override val titleResourceId = R.string.statistic_category_threes
	},
	ACES {
		override val titleResourceId = R.string.statistic_category_aces
	},
	CHOPS {
		override val titleResourceId = R.string.statistic_category_chops
	},
	SPLITS {
		override val titleResourceId = R.string.statistic_category_splits
	},
	TAPS {
		override val titleResourceId = R.string.statistic_category_taps
	},
	TWELVES {
		override val titleResourceId = R.string.statistic_category_twelves
	},
	FOULS {
		override val titleResourceId = R.string.statistic_category_fouls
	},
	PINS_LEFT_ON_DECK {
		override val titleResourceId = R.string.statistic_category_pins_left_on_deck
	},
	MATCH_PLAY_RESULTS {
		override val titleResourceId = R.string.statistic_category_match_play_results
	},
	SERIES {
		override val titleResourceId = R.string.statistic_category_series
	}, ;
...
enum class StatisticID {
	...
	CHOPS {
		override val titleResourceId = R.string.statistic_title_chop_offs
	},
	CHOPS_SPARED {
		override val titleResourceId = R.string.statistic_title_chop_offs_spared
	},
	FIVES {
		override val titleResourceId = R.string.statistic_title_fives
	},
	FIVES_SPARED {
		override val titleResourceId = R.string.statistic_title_fives_spared
	},
	HEAD_PINS {
		override val titleResourceId = R.string.statistic_title_head_pins
	},
	HEAD_PINS_SPARED {
		override val titleResourceId = R.string.statistic_title_head_pins_spared
	},
	LEFT_CHOPS {
		override val titleResourceId = R.string.statistic_title_left_chop_offs
	},
	LEFT_CHOPS_SPARED {
		override val titleResourceId = R.string.statistic_title_left_chop_offs_spared
	},
	LEFT_FIVES {
		override val titleResourceId = R.string.statistic_title_left_fives
	},
	LEFT_FIVES_SPARED {
		override val titleResourceId = R.string.statistic_title_left_fives_spared
	},
	LEFT_SPLITS {
		override val titleResourceId = R.string.statistic_title_left_splits
	},
	LEFT_SPLITS_SPARED {
		override val titleResourceId = R.string.statistic_title_left_splits_spared
	},
	LEFT_TAPS {
		override val titleResourceId = R.string.statistic_title_left_taps
	},
	LEFT_TAPS_SPARED {
		override val titleResourceId = R.string.statistic_title_left_taps_spared
	},
	LEFT_THREES {
	...
	LEFT_TWELVES {
		override val titleResourceId = R.string.statistic_title_left_twelves
	},
	LEFT_TWELVES_SPARED {
	...
	RIGHT_FIVES {
		override val titleResourceId = R.string.statistic_title_right_fives
	},
	RIGHT_FIVES_SPARED {
		override val titleResourceId = R.string.statistic_title_right_fives_spared
	},
	RIGHT_SPLITS {
		override val titleResourceId = R.string.statistic_title_right_splits
	},
	RIGHT_SPLITS_SPARED {
		override val titleResourceId = R.string.statistic_title_right_splits_spared
	},
	RIGHT_TAPS {
		override val titleResourceId = R.string.statistic_title_right_taps
	},
	RIGHT_TAPS_SPARED {
		override val titleResourceId = R.string.statistic_title_right_taps_spared
	},
	RIGHT_THREES {
		override val titleResourceId = R.string.statistic_title_right_threes
	},
	RIGHT_THREES_SPARED {
		override val titleResourceId = R.string.statistic_title_right_threes_spared
	},
	RIGHT_TWELVES {
		override val titleResourceId = R.string.statistic_title_right_twelves
	},
	RIGHT_TWELVES_SPARED {
		override val titleResourceId = R.string.statistic_title_right_twelves_spared
	},
	SPLITS {
		override val titleResourceId = R.string.statistic_title_splits
	},
	SPLITS_SPARED {
		override val titleResourceId = R.string.statistic_title_splits_spared
	},
	TAPS {
		override val titleResourceId = R.string.statistic_title_taps
	},
	TAPS_SPARED {
		override val titleResourceId = R.string.statistic_title_taps_spared
	},
	THREES {
		override val titleResourceId = R.string.statistic_title_threes
	},
	THREES_SPARED {
		override val titleResourceId = R.string.statistic_title_threes_spared
	},
	TWELVES {
		override val titleResourceId = R.string.statistic_title_twelves
	},
	TWELVES_SPARED {
	...
	STRIKES {
		override val titleResourceId = R.string.statistic_title_strikes
	},
	MATCHES_LOST {
		override val titleResourceId = R.string.statistic_title_match_play_losses
	},
	MATCHES_WON {
