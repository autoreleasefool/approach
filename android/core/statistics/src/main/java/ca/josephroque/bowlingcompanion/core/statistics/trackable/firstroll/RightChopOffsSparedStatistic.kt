...
data class RightChopOffsSparedStatistic(var rightChops: Int = 0, var rightChopsSpared: Int = 0) :
	...
	override fun emptyClone() = RightChopOffsSparedStatistic()
