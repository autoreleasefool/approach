...
data class TwelvesSparedStatistic(var twelves: Int = 0, var twelvesSpared: Int = 0) :
	TrackablePerSecondRoll,
	SecondRollStatistic {
	override val id = StatisticID.TWELVES_SPARED
	...
	override fun emptyClone() = TwelvesSparedStatistic()
