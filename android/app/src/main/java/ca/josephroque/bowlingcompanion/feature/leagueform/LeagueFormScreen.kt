	...
	Scaffold(
		...
		when (leagueFormState) {
			...
			is LeagueFormUiState.Create ->
				LeagueForm(
					name = leagueFormState.name,
					onNameChanged = onNameChanged,
					nameErrorId = leagueFormState.fieldErrors.nameErrorId,
					recurrence = leagueFormState.recurrence,
					onRecurrenceChanged = onRecurrenceChanged,
					excludeFromStatistics = leagueFormState.excludeFromStatistics,
					onExcludeFromStatisticsChanged = onExcludeFromStatisticsChanged,
					numberOfGames = leagueFormState.numberOfGames,
					...
					additionalPinFall = leagueFormState.additionalPinFall,
					onAdditionalPinFallChanged = onAdditionalPinFallChanged,
					additionalGames = leagueFormState.additionalGames,
