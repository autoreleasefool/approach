...
sealed interface NewUserOnboardingUiState {
	...
	data class ShowingLogbook(val name: String, val enabled: Boolean) : NewUserOnboardingUiState
}
...
sealed interface NewUserOnboardingUiAction {
	...
	data class NameChanged(val name: String) : NewUserOnboardingUiAction
}
