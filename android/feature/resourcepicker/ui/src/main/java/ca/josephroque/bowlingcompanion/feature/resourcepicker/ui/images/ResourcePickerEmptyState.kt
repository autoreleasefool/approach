package ca.josephroque.bowlingcompanion.feature.resourcepicker.ui.images
...
@Composable
fun imageResourcePickerEmptyState(accentColor: Color = MaterialTheme.colorScheme.primary): ImageVector {
	LaunchedEffect(isSystemInDarkTheme()) {
		// Clear cached image when theme changes
		_ResourcePickerEmptyState = null
	}
	if (_ResourcePickerEmptyState != null) {
		return _ResourcePickerEmptyState!!
	}
	_ResourcePickerEmptyState = ImageVector.Builder(
		name = "ResourcePickerEmptyState",
...
private var _ResourcePickerEmptyState: ImageVector? = null
