...
public class ImageUtils
{
    ...
    public static Bitmap createImageFromSeries(Context context, long seriesId)
    {
        ...
        String rawImageQuery = "SELECT "
                ...
                + " ORDER BY " + GameEntry.COLUMN_GAME_NUMBER + ", " + FrameEntry.COLUMN_FRAME_NUMBER;
     ...
     */
    @SuppressWarnings("all") //Ignoring try with automatic resource management in case java 1.6 is used
