...
final class GameAverageTests: XCTestCase {
	...
	func testDoesNotAdjustByZeroGames() {
		let statistic = create(
			...
			adjustedByGames: [
				Game.TrackableEntry(seriesId: UUID(0), id: UUID(0), index: 0, score: 100, date: Date(timeIntervalSince1970: 123), matchPlay: nil),
				Game.TrackableEntry(seriesId: UUID(0), id: UUID(1), index: 1, score: 120, date: Date(timeIntervalSince1970: 123), matchPlay: nil),
				Game.TrackableEntry(seriesId: UUID(0), id: UUID(2), index: 2, score: 0, date: Date(timeIntervalSince1970: 123), matchPlay: nil),
			]
		)
