...
final class FivesSparedTests: XCTestCase {
	func testAdjust_ByFramesWithFivesSpared_Adjusts() {
	...
	func testAdjust_ByFramesWithoutFivesSpared_DoesNotAdjust() {
		let statistic = create(
			statistic: Statistics.FivesSpared.self,
			adjustedByFrames: [
				Frame.TrackableEntry(
	...
	func testAdjustByGame_DoesNothing() {
		let statistic = create(statistic: Statistics.FivesSpared.self, adjustedByGames: Game.TrackableEntry.mocks)
		AssertPercentage(statistic, hasNumerator: 0, withDenominator: 0, formattedAs: "0%")
	}
}
