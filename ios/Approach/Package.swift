...
let package = Package(
	...
	dependencies: [
		...
		.package(url: "https://github.com/pointfreeco/swift-composable-architecture.git", from: "1.5.3"),
		...
		.package(url: "https://github.com/RevenueCat/purchases-ios.git", from: "4.31.2"),
