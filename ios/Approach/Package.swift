...
let package = Package(
	...
	products: [
		...
		.library(name: "TeamsRepository", targets: ["TeamsRepository"]),
		.library(name: "TeamsRepositoryInterface", targets: ["TeamsRepositoryInterface"]),
