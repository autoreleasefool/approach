...
public struct GearList: Reducer, Sendable {
	...
	public struct State: Equatable {
		@Shared
		public var fetchRequest: Gear.Summary.FetchRequest
		@Shared(.ordering)
		...
		public init(kind: Gear.Kind?) {
			...
			let fetchRequest: Shared<Gear.Summary.FetchRequest> = Shared(value: .init(kind: kind, ordering: ordering.wrappedValue))
