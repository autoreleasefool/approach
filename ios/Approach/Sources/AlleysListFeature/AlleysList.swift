...
public struct AlleysList: Reducer, Sendable {
	...
	public struct State: Equatable {
		@Shared
		public var fetchRequest: Alley.List.FetchRequest
		@Shared(.ordering)
		...
		public init() {
			...
			let fetchRequest: Shared<Alley.List.FetchRequest> = Shared(value: .init(filter: .init(), ordering: ordering.wrappedValue))
