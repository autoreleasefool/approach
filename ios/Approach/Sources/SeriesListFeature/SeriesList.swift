...
public struct SeriesList: Reducer, Sendable {
	...
	public struct State: Equatable {
		...
		@Shared
		public var fetchRequest: Series.List.FetchRequest
		@Shared
		...
		public init(league: League.SeriesHost) {
			self.league = league
			let ordering: Shared<Series.Ordering> = Shared(value: .newestFirst)
			let fetchRequest: Shared<Series.List.FetchRequest> = Shared(
				value: .init(
					league: league.id,
