 ...
 *
 * Name of the team whose statistics are on display.
 */
class TeamNameStatistic(override var value: String = "") : StringStatistic {
    ...
    companion object {
        ...
        @Suppress("unused")
        @JvmField val CREATOR = parcelableCreator(::TeamNameStatistic)

        /** Unique ID for the statistic. */
        const val Id = R.string.statistic_team
    }
