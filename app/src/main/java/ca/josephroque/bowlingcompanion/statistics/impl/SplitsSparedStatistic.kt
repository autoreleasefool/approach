 ...
 */
class SplitsSparedStatistic(numerator: Int, denominator: Int) : SecondBallStatistic(numerator, denominator) {

    // MARK: Modifiers

    /** @Override */
    override fun isModifiedByFirstBall(deck: Deck) = deck.isSplit
